...
TODO:
    ...
    - make loggin setup work
"""

# S15
# PATH_TO_PLTFILES = '/home/template_scripts/FLASH/2D_simulation/S15_Ritter_hf10_2d/output/S15_Ritter_hf10_hdf5_plt_cnt'
# PATH_TO_OUTPUT = '/home/bweinhold/Auswertung/2D_Analysis/2D_Tracers/data/Simulations/S15_Ritter_hf10/test_pos_25_ms_-3'
...
CHUNK_SIZE = 1000                                               # tracers are integrated throughout the simulation in chunks
RTOL, ATOL, MAXSTEP = 1e-2, 1e4, 1e-3                           # tolerances for solve_ivp/RKF5 - see README
...
PROG_TYPE = 'FLASH'     #FLASH/NuGrid                                        # type of progenitor file must be in progenitors.py (see README)                   
