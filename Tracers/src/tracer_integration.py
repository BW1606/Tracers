...
from config import PATH_TO_OUTPUT, MAXTEMP_TRACER, NSE_TEMP, ONLY_UNTIL_MAXTEMP, XMIN, XMAX, YMAX, YMIN, DIRECTION, CHUNK_SIZE
...
match DIRECTION:
    ...
    case 'backward':
        sgn = -1
    case _:
        raise ValueError(f'Unknown integration direction, DIRECTION={DIRECTION}')
